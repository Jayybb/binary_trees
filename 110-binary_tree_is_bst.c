 ...
 * @lo: The value of the smallest node so far.
 * @hi: The value of the largest node visited so far.
 *
 * Return: If the tree is a valid BST return 1, otherwise, 0.
 */
 ...
 * @tree: This is a pointer to the root node of tree to check.
 *
